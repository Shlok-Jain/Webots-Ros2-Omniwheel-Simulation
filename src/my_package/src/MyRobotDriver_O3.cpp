#include "my_package/MyRobotDriver_O3.hpp"
...
namespace my_robot_driver_O3 {
  ...
  void MyRobotDriver::init(
    ...
    cmd_vel_subscription_ = node->create_subscription<geometry_msgs::msg::Twist>(
        "/O3/cmd_vel", rclcpp::SensorDataQoS().reliable(),
    ...
    gps_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O3/gps_data", 10);
    imu_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O3/imu_data", 10);
    encoder_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O3/encoder_data", 10);
...
PLUGINLIB_EXPORT_CLASS(my_robot_driver_O3::MyRobotDriver, webots_ros2_driver::PluginInterface)
