...
namespace my_robot_driver_O1 {
  ...
  void MyRobotDriver::init(
    ...
    gps_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O1/gps_data", 10);
    imu_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O1/imu_data", 10);
    encoder_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O1/encoder_data", 10);
