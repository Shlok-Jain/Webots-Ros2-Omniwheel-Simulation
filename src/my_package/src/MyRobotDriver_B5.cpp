#include "my_package/MyRobotDriver_B5.hpp"
...
namespace my_robot_driver_B5 {
  ...
  void MyRobotDriver::init(
    ...
    cmd_vel_subscription_ = node->create_subscription<geometry_msgs::msg::Twist>(
        "/B5/cmd_vel", rclcpp::SensorDataQoS().reliable(),
    ...
    gps_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("B5/gps_data", 10);
    imu_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("B5/imu_data", 10);
    encoder_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("B5/encoder_data", 10);
...
PLUGINLIB_EXPORT_CLASS(my_robot_driver_B5::MyRobotDriver, webots_ros2_driver::PluginInterface)
