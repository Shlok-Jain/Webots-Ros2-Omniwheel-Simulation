...
namespace my_robot_driver_O5 {
  ...
  void MyRobotDriver::init(
    ...
    gps_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O5/gps_data", 10);
    imu_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O5/imu_data", 10);
    encoder_publisher_ = node->create_publisher<std_msgs::msg::Float32MultiArray>("O5/encoder_data", 10);
